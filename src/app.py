...
activities = {
    "Soccer Team": {
        "description": "Team practices and matches focused on soccer skills and teamwork",
    ...
    "Math Olympiad Prep": {
        "description": "Advanced problem-solving sessions for mathematics competitions",
...
# DELETE endpoint to unregister a student from an activity
